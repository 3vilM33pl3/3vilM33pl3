...
- 🧠 **[Memory](https://github.com/3vilM33pl3/memory)** - My own distributed memory system for coding agents
...
- **[SCTP Conformance Suite](https://github.com/3vilM33pl3/sctp-conformance)** - FreeBSD reference-backed SCTP feature server with a browser dashboard and LLM-built client workflows for the Go and Rust runtime forks to test their implementations.
- **[SCTP in Go on FreeBSD](https://github.com/3vilM33pl3/go-sctp-thesis)** - This project is part of my Masters Thesis and presented at the BSD conferences in Asia, Europe and Canada in 2012 and 2013.
- **[SCTP in Go on Linux](https://github.com/3vilM33pl3/go-sctp)** - Revisiting my old SCTP in Go project, now with the latest version of Go on Linux, done with the power of LLMs(!)
...
## GitHub Activity
![GitHub Contribution Graph](https://ghchart.rshah.org/3vilM33pl3)

## Recognition ##
- SCTP in Go [presentation](https://www.youtube.com/watch?v=0bsxjosoSoc) and [paper](https://arxiv.org/pdf/1711.07224) 
 at [EuroBSD 2012](https://2012.eurobsdcon.org/), [BSDCan 2012](https://www.bsdcan.org/2012/) and [AsiaBSD 2013](https://2013.asiabsdcon.org/) 
- Part of the team who delivered first version of [BBC iPlayer](https://www.bbc.co.uk/iplayer)
- [Patent: Synthetic generation of data with many to many relationships](https://patents.google.com/patent/WO2023223044A1/)
...
- 🛠️ Shipping small tools to make life easier

## Connect
[![Linkedin](https://i.sstatic.net/gVE0j.png) LinkedIn](https://www.linkedin.com/in/olivierva/)
&nbsp;
[![GitHub](https://i.sstatic.net/tskMh.png) GitHub](https://github.com/3vilM33pl3)
